...
<div class="test">
    <ol class="nav flex-column"><li class="nav-item"><span class="nav-link">Tee</span><ol class="nav flex-column"><li class="nav-item"><a class="nav-link" href="https://green.tee.com"><span class="fa fa-fw fa-check"></span> Green</a></li><li class="nav-item"><a class="nav-link" href="https://black.tee.com">Black</a></li></ol></li><hr/><li class="nav-item"><span class="nav-link">Heros</span><ol class="nav flex-column"><li class="nav-item"><a class="nav-link" href="https://superman.com">Superman</a></li><li class="nav-item"><a class="nav-link" href="https://batman.com">Batman</a></li></ol></li></ol>
</div>
